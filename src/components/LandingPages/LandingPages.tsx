...
import { LandingPageTable, actionItemLabel } from '../PageTable';
import { PublishModal, UnpublishModal } from '../Modals';
import NoticeManager from '../NoticeManager';
import { getErrorMessage, AUTH_ERROR_CODES } from '../../utils/api';
...
const LandingPages: React.FC<Props> = ({ onAuthenticationError }) => {
    ...
    const handleFetchError = (e: WPResponseError) => {
        if (AUTH_ERROR_CODES.includes(e.code)) {
